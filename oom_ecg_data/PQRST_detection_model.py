...
with tf.device('/CPU:0'):
    r_index_model = load_tflite_model("D:\\hitesh\\new ui\\ecgdatabank_new\\oom_ecg_data\\model\\rnn_model1_29_10_Unet.tflite")
    pt_index_model = load_tflite_model("D:\\hitesh\\new ui\\ecgdatabank_new\\oom_ecg_data\\model\\ecg_pt_detection_LSTMGRU_TCN_Transpose_v27.tflite")
