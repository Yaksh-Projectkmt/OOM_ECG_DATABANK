...
USERNAME = "kmt"
PASSWORD = "Kmt123"
TOPIC_Y = "oom/ecg/processedDataOffline"
...
#         if "starttime" in doc:
#             try:
#                 # assuming int timestamp in milliseconds
#                 doc["starttime"] = datetime.utcfromtimestamp(int(doc["starttime"]) / 1000)
#             except Exception as e:
#                 print("Error converting starttime:", e)
#         if "endtime" in doc:
#             try:
#                 doc["endtime"] = datetime.utcfromtimestamp(int(doc["endtime"]) / 1000)
#             except Exception as e:
#                 print("Error converting endtime:", e)
        
#         # Convert patient string to ObjectId if possible
#         if "patient" in doc:
#             try:
#                 doc["patient"] = ObjectId(doc["patient"])
#             except Exception as e:
#                 print("Error converting patient to ObjectId:", e)
                
#         doc["_status"] = "pending"
#         doc["_queue"] = queue_counter
