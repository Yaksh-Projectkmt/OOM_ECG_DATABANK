...
def check_vfib_vfl_model(low_ecg_signal, let_inf_moedel):
    label = 'Abnormal'
    img_path = r'/home/system/ecgdatabank_copy/Scripts_Models/Temp/'
    temp_vifib_img_path = os.path.join( img_path, 'temp_vifib_img')
...
class PDF(FPDF):
    ...
    def add_summary(self, label_counts,hr_counts):
      ...
      self.cell(col_widths[2], 10, "Occurance", 1, align="C")
...
def model_check_for_ecg_data(file_path, is_lead_for):
    let_inf_moedel = load_tflite_model(os.getenv("VIFIB"))
    frequency = 200
    label_counts = {}
    hr_counts={}
    ecg_pdf_buffers = []
