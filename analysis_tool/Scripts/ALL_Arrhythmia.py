...
def check_r_index(all_leads_data, version, frequency):
    ...
    elif version == "7_Lead" or version == "12_Lead":
...
def mi_processing(all_lead_data, is_lead, fs):
    ...
    if is_lead != '2_Lead':# ele[i, avl, v5, v6] dep[iii, avf]latral ------ ele[ii, iii, avf] dep[avl] inf
...
class PVCDetection:
    def __init__(self, get_signal, fs, r_index, is_lead = "2_Lead"):
    ...
    def get_pvc_data(self):
        ...
        if self.is_lead == '12_Lead':
            analysis_lead = ['I','II','III', 'aVL', 'v1', 'v5','v6']
        elif self.is_lead == '7_Lead':
...
class PACDetection:
    def __init__(self,get_signal, r_index, fs, is_lead = "2_Lead"):
        self.get_signal = get_signal
        self.fs = fs
        self.is_lead = is_lead
        self.r_index = r_index
...
# def plotting(result_dic, ecg_data, save_path, local_name, is_lead_for, pdf, label_counts, hr_counts):
#     # ---------------------------
#     # 1. Lead Group Definitions
#     # ---------------------------
#     if is_lead_for == "12_Lead":
...
#     # 2. Prepare Figure
#     # ---------------------------
#     fig_size = (14, 10) if is_lead_for != "2_Lead" else (8, 4)
...
#     # 8. Save PDF
#     # ---------------------------
#     output_file = os.path.join(save_path, f"{local_name}.pdf")
...
# def model_check_for_ecg_data(path, is_lead,save_result):

#     is_lead_for = is_lead
#     frequency = 200 if is_lead in ["2_Lead", "7_Lead"] else 240
#     label_counts = {}
#     hr_counts={}
#     pdf = PDF()
...
#             plotting(results_dic, ecg_data,save_result,local_name, is_lead_for,pdf, label_counts,hr_counts)
#             i += steps
