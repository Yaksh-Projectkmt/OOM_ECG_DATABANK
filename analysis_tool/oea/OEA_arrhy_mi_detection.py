...
img_interpreter, img_input_details, img_output_details = load_tflite_model(base_dir_path +"/Models/restingecgModel_autoGrid_17.tflite")
interpreter = tf.lite.Interpreter(model_path= base_dir_path +"/Models/PVC_Trans_mob_88_test_tiny_iter1_small_minimal.tflite")
interpreter.allocate_tensors()

input_details = interpreter.get_input_details()
output_details = interpreter.get_output_details()
pac_model = load_tflite_model(base_dir_path + "/Models/PAC_TRANS_GRU_mob_48_Minimal.tflite")
afib_model = load_tflite_model(base_dir_path + "/Models/afib_flutter_12_8.tflite")
vfib_vfl_model = load_tflite_model(base_dir_path + "/Models/vfib_trans_mob_36_enhanced.tflite")
block_model = load_tflite_model(base_dir_path + "/Models/Block_Trans_mob_29_super_new_minimal.tflite")
noise_model = load_tflite_model(base_dir_path + "/Models/NOISE_19_GPT.tflite")
...
def process_and_plot_leads(ecg_df, file_name, result,top_label, class_name="6_2", mm_per_sec=25, mm_per_mV=10, signal_scale=0.01):
    ...
    fig.suptitle('\n'.join(title_lines), fontsize=16, x=0.5, y=0.98, ha='center', va='top', fontweight='bold')
    ...
    plt.figtext(0.5, 0.005, bottom_label, ha='center', fontsize=16, wrap=True, fontfamily='monospace',fontweight='bold')
    ...
    temp_path = base_dir_path + f"/cropped_lead_images/temp_path/{file_name}_temp.jpg"
