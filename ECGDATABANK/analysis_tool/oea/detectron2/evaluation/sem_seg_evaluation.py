...
from analysis_tool.oea.detectron2.data import DatasetCatalog, MetadataCatalog
from analysis_tool.oea.detectron2.utils.comm import all_gather, is_main_process, synchronize
