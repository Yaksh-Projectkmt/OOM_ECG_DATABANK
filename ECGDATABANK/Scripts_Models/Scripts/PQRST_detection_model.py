...
with tf.device('/CPU:0'):
    r_index_model = load_tflite_model("D:\\try3\\Scripts_Models\\Model\\rnn_model1_12_01_final.tflite")
    pt_index_model = load_tflite_model("D:\\try3\\Scripts_Models\\Model\\ecg_pt_detection_LSTMGRU_v32.tflite")
